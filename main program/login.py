...
class loginscreen(tk.Frame):
    def __init__(self, screen, root):
        ...
        loginframe = tk.Frame(self, bg="lightblue")
        loginframe.place(relx=0.5,rely=0.6,relwidth=.3,relheight=.15,anchor='center')
        username_label = tk.Label(loginframe, text="ENTER USERNAME")
        ...
        nextpagebutton = tk.Button(nextpageframe, text="next page", command=nextpage)

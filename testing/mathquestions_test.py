...
def Question_template(text,colour,x_pos,y_pos,x_length,y_length, question_used, question2, answer2):
    frame = tk.Frame(root,bg=colour)
    frame.place(relx=x_pos,rely=y_pos,relwidth=x_length,relheight=y_length)
    ...
    def new_question():
        ...
        question_label.config(text=f"{question2}{format_fixer(question)}")
        answer_label.config(text=f"{answer2}{format_fixer(answer)}")

    button = tk.Button(frame, text="New Question", command=new_question)
...
differentiation_basic = Question_template(
    ...
    0.4,
    0.18,
    differentiation_basic_achieved,
    "y = ",
    "y' = "
)
differentiation_product = Question_template(
    ...
    0.4,
    0.18,
    differentiation_product_achieved,
    "y = ",
    "y' = "
)
differentiation_quotient = Question_template(
    "DIFFERENTIATION_QUOTIENT",
    "yellow",
    0.1,
    0.4,
    0.4,
    0.18,
    differentiation_quotient_achieved,
    "y = ",
    "y' = "
)
differentiation_chain = Question_template(
    ...
    0.4,
    0.18,
    differentiation_chain_achieved,
    "y = ",
    "y' = "
)
complex_multiplication = Question_template(
    "COMPLEX_ADDITION",
    "blue",
    0.1,
    0.8,
    0.4,
    0.18,
    complex_multiplication_achieved,
    "question:",
    "answer:"
)
complex_division = Question_template(
    "COMPLEX_DIVISION",
    "purple",
    0.4,
    0.05,
    0.4,
    0.18,
    complex_division_achieved,
    "question:",
    "answer:"
)
complex_argument = Question_template(
    "COMPLEX_ARGUEMENT",
    "pink",
    0.4,
    0.2,
    0.4,
    0.18,
    complex_argument_achieved,
    "question:",
    "answer:"
)
complex_modulus = Question_template(
    "COMPLEX_MODULUS",
    "brown",
    0.4,
    0.4,
    0.4,
    0.18,
    complex_modulus_achieved,
    "question:",
    "answer:"
)
complex_cartesian = Question_template(
    "COMPLEX_CARTESIAN",
    "black",
    0.4,
    0.6,
    0.4,
    0.18,
    complex_cartesian_merit,
    "question:",
    "answer:"
)
complex_quadratic = Question_template(
    "COMPLEX_QUADRATIC",
    "white",
    0.4,
    0.8,
    0.4,
    0.18,
    complex_quadratic_achieved,
    "question:",
    "answer:"
)
differentiation_stationary = Question_template(
    "DIFFERENTIATION_STATIONARY",
    "maroon",
    0.8,
    0.05,
    0.2,
    0.18,
    differentiation_stationary_merit,
    "question:",
    "answer:"
)
differentiation_tangent = Question_template(
    "DIFFERENTIATION_TANGENT",
    "magenta",
    0.7,
    0.2,
    0.30,
    0.18,
    differentiation_tangent_merit,
    "",
    ""
)
complex_polar = Question_template(
    "COMPLEX_POLAR",
    "dark grey",
    0.7,
    0.4,
